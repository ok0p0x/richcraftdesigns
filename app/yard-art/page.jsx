    ...
    <main>
      ...
      <section className="yard-page shell">
        <div className="section-heading yard-heading">
          ...
          <h1>Rustic outdoor pieces staged for cabins, shops, gardens, fences, patios, and wide-open spaces.</h1>
        ...
        {yardArt.length === 0 ? (
          <div className="empty-gallery">
            No yard art images were found in <strong>public/projects</strong>.
          </div>
        ) : (
