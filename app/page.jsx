...
const services = [
  ...
  {
    title: "Metal & Plasma",
    text: "Decorative cuts, shop pieces, rugged signs, metal accents, yard art, and outdoor pieces with a little spark baked in.",
  },
];
    ...
    <main>
      ...
      <section id="top" className="hero shell">
        <div className="hero-copy">
          ...
          <h1>
            Custom laser, wood, and metal work for people who want something
            personal.
          </h1>

          <p className="hero-text">
            Every project starts as a rough idea, sketch, fandom, logo, memory,
            or problem to solve. Rich Craft Designs specializes in custom laser,
            wood, metal, and illuminated creations built around your ideas,
            interests, and spaces. Many of the pieces featured throughout the
            site are available for purchase and also serve as examples of the
            shop’s custom design and fabrication capabilities.
          </p>

          <div className="button-row">
            <a className="button primary" href="/custom-order">
              Request Custom Work
            </a>

            <a
              className="button secondary"
              href="https://www.etsy.com/shop/RichCraftMade"
            >
              Shop Etsy
            </a>
          </div>
      ...
      <section className="intro-strip shell">
        <div>
          ...
          <span>
            Most work starts with your idea, space, theme, logo, fandom, or
            rough sketch.
          </span>
        </div>
        ...
        <div>
          ...
          <span>
            Laser engraving, woodworking, plasma cutting, finishing, lighting,
            and assembly.
          </span>
        </div>
        ...
        <div>
          ...
          <span>
            Finished pieces may be available, but they also show what can be
            customized.
          </span>
        </div>
      </section>
      ...
      <section id="work" className="work-section shell">
        <div className="section-heading">
          ...
          <h2>
            Real projects, clean details, and enough shop grit to prove it was
            built, not printed.
          </h2>
        </div>
      ...
      <section className="yard-art-teaser shell">
        <div className="custom-card">
          ...
          <h2>
            Rustic outdoor pieces for cabins, shops, gardens, fences, patios,
            and wide-open spaces.
          </h2>

          <p>
            Browse staged examples of metal yard art and outdoor pieces. Pick
            from existing work or use the gallery as a starting point for a
            custom metal project.
          </p>

          <div className="button-row">
            <a className="button primary" href="/yard-art">
              View Yard Art Gallery
            </a>
          </div>
        </div>
      </section>
      ...
      <section id="custom" className="custom-section shell">
        <div className="custom-card">
          ...
          <h2>
            Have an idea? Send the rough version. The polished version starts
            here.
          </h2>

          <p>
            Logos, themes, photos, fandoms, names, dates, dimensions, cabin
            ideas, tabletop gear, memorial pieces, yard art, and oddball
            concepts are all fair game.
          </p>
